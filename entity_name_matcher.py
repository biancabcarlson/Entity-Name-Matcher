...
A dependency-free tool for KYC / case-review work that identifies reused
PII across accounts, including matches to retired contact information --
name variants, matching emails, matching phone numbers, matching
addresses -- a common signal for duplicate accounts, synthetic
identities, or an account takeover where the attacker recycles the
victim's retired contact info on a second account.
