...
Identify reused PII across accounts, including matches to retired contact information. Built for KYC / case-review work: catching duplicate accounts, synthetic identities, or an account takeover where the attacker opens a second account using the victim's *retired* contact info (an old email or phone number the victim no longer uses).
